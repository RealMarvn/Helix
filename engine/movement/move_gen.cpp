            ...
            if (FST != 0 && SND != 0) {
                ...
                if (piece.piece_type != EMPTY) {
                    ...
                    if ((PIECE_COLOR && y == 8) || (!PIECE_COLOR && y == 1)) {
                        ...
                        for (int promotionIndex = 0; promotionIndex < 4; promotionIndex++) {
                            move.promotion_piece.piece_type = (PIECE_COLOR
                                                                   ? white_pawn_possible_promotions[promotionIndex]
                ...
                if (SND == 2) {
                    if ((PIECE_COLOR && START_SQUARE.second == 2) ||
                        ...
                        if (board[calculateSquare(x, START_SQUARE.second + (PIECE_COLOR ? 1 : -1))].piece_type ==
                            EMPTY) {
