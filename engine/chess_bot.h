...
class ChessBot
{
  ...
  private:
    std::unique_ptr<std::array<Move, tt_size>> tt_array =
        std::make_unique<std::array<Move, tt_size>>();
     ...
     * time, and checks if the elapsed time is greater than or equal to 2 seconds.
     *
     ...
     * the position of the pieces on the board. It takes into account both the middle game and end
    ...
    constexpr static int mg_bishop_table[64] = {
    ...
    constexpr static int eg_bishop_table[64] = {
    ...
    constexpr static int mg_queen_table[64] = {
    ...
    constexpr static int eg_queen_table[64] = {
    ...
    constexpr static int mg_king_table[64] = {
    ...
    constexpr static int eg_king_table[64] = {
