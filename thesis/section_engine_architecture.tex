...
The focus lies on the structural design decisions and the interaction between
the core components; the rationale behind these decisions is summarized at the
end of the section.
