...
information, the class of games for which the classical game-tree search methods
discussed below were developed~\cite{yannakakis2018artificial}. At any point in
time, the complete game state is fully observable to both players, and no
randomness is involved in the game mechanics.
...
formulation, a reformulation that is standard in game-tree search and treated
in the surveys of the field~\cite{marsland1986review, knuth1975alphabeta}. Instead of explicitly distinguishing between maximizing and
